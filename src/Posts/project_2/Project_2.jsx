    ...
    return (
        <>
          <Page>
            ...
            <Block>
              <Media source={working_poxy} Width={'4npm 0%'} minWidth={'100px'} 
            ...
            <Media source={CPLD} Width={'70%'} minWidth={'100px'} 
                             caption={'Figure 4 - CPLD design of a UART receiver and 7 segment display'} maxWidth={'800px'} 
                             Float={'none'}/>
